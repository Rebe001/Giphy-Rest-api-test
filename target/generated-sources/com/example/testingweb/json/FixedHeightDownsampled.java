...
public class FixedHeightDownsampled {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.webpSize == rhs.webpSize)||((this.webpSize!= null)&&this.webpSize.equals(rhs.webpSize)))&&((this.size == rhs.size)||((this.size!= null)&&this.size.equals(rhs.size))))&&((this.width == rhs.width)||((this.width!= null)&&this.width.equals(rhs.width))))&&((this.webp == rhs.webp)||((this.webp!= null)&&this.webp.equals(rhs.webp))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.height == rhs.height)||((this.height!= null)&&this.height.equals(rhs.height))));
    }
