...
public class Meta {
    ...
    public boolean equals(Object other) {
        ...
        Meta rhs = ((Meta) other);
        return (((((this.msg == rhs.msg)||((this.msg!= null)&&this.msg.equals(rhs.msg)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))))&&((this.responseId == rhs.responseId)||((this.responseId!= null)&&this.responseId.equals(rhs.responseId))));
    }
